...
cleaned_data <- read_csv("C:/Users/Storm/Desktop/University Tings/3rd Year/ITRDA3-11/ITRDA3-11 - Assignment - Online - EDUV4817334/cleaned_graduate_survey.csv")

# Function to process multi-value columns with better handling
...
## I. Top Tools Used by Graduates (12 marks)

# Create a list to store all tool plots
tool_plots <- list()
...
# Display all tool plots in sequence
for (plot in tool_plots) {
  print(plot)
}

## II. Most Popular Industries (8 marks)

# Create a better visualization of industries by study field
...
## III. Top Job Roles (5 marks)

# Create a better visualization of top roles by study field
...
## IV. Employment Rate (5 marks)

# Calculate employment rate with better visualization
...
# Binary employment rate (just Employed vs. Not Employed)
...
ggplot(employment_rate_simple, aes(x = StudyField, y = Percentage, fill = EmploymentSimplified)) +
  ...
  scale_fill_brewer(palette = "Set2") +  # Using a color palette with fewer colors
...
# Plot binary employment rates (Employed vs Not Employed)
# This is probably the most appropriate for your assignment question
...
# Create a summary table for the binary employment rates
...
# Summary tables for easy answer extraction
# I. Top tools summary
...
# II. Most popular industries summary
